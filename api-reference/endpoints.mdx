---
title: "API Endpoints"
description: "Complete reference for Aqua Protocol REST API endpoints"
icon: "api"
---
...
REST APIs are used to interact with the Aqua-Protocol in Client-Server applications. This includes data syncing and exchange operations between different aqua-services. Early versions of this API were prototypes within the PKC-Guardian project.
...
- `X-File-Hash`: The file's hash for client-side verification.
...
**Method:** POST  
**Path:** `/session`  
**Description:** Creates a new session using SIWE-OIDC authentication.
...
const latest = await client.getLatestRevisions('0xgenesis_hash...', {
  includeMetadata: true
});

// Create new revision
const revision = await client.createRevision({
  previous_verification_hash: '0xprevious_hash...',
  revision_type: 'signature',
  signature: '0xsignature...',
  signature_public_key: '0xpublic_key...',
  signature_wallet_address: '0xwallet_address...',
  signature_type: 'ethereum:eip-191'
});
...
# Get latest revisions
latest = client.get_latest_revisions('0xgenesis_hash...', include_metadata=True)
