...
description: "A Cryptographic Trust Protocol for Decentralized Data Integrity"
icon: "droplet"
---
...
**Decentralized Identity Solution**: A new approach to identity management ([Aqua Identity](https://github.com/inblockio/aqua-identity)). Please request a demo with us via demo@inblock.io.
